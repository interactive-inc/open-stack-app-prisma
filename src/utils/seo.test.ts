...
describe("seo", () => {
  test("should return basic meta tags with required title", () => {
    ...
    expect(result).toContainEqual({ name: "twitter:description", content: undefined })
    ...
    expect(result).toContainEqual({ name: "og:description", content: undefined })
  })
  ...
  test("should include description when provided", () => {
    ...
    expect(result).toContainEqual({ name: "og:description", content: "Test Description" })
  })
  ...
  test("should return all meta tags with all props provided", () => {
    ...
    expect(result).toContainEqual({ name: "description", content: "Complete Description" })
    expect(result).toContainEqual({ name: "keywords", content: "complete, test, all" })
    expect(result).toContainEqual({ name: "twitter:title", content: "Complete Page" })
    expect(result).toContainEqual({ name: "twitter:description", content: "Complete Description" })
    expect(result).toContainEqual({ name: "twitter:image", content: "https://example.com/complete.jpg" })
    expect(result).toContainEqual({ name: "twitter:card", content: "summary_large_image" })
    expect(result).toContainEqual({ name: "og:title", content: "Complete Page" })
    expect(result).toContainEqual({ name: "og:description", content: "Complete Description" })
    expect(result).toContainEqual({ name: "og:image", content: "https://example.com/complete.jpg" })
  })
})
