---
name: docs
description: Structure and rules for .docs/ directory. Manages product specs, decisions, backlogs, and signals (customer feedback). Keeps docs in sync with code through periodic review.
---
...
- [signals.md](references/signals.md): ユーザーの声
